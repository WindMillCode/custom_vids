    ...
    @HostListener('blur',['$event']) onBlur(event){
        if(this.extras?.confirm === "true"){
            ...
            ryberUpdate.call(this.ryber,{
                co,
                bool: 'h3',
                text:'Check out your view children variable',
                val: 'remove-value',
                css:{
                    ...
                    // "width":"300px",
                    "font-size":"24px",
                    "top":(numberParse(zChild.css.top) + 100).toString() + "px",
                    "position":"relative"
                    // "left":""
                },
                extras:{
            ...
            // SEE what this code does
                // can you dig through the framework to figure out how to improve it
